...
class Invoice
{
	...
	void setPartNumber( string ); string getPartNumber();
	void setPartDescription(string); string getPartDescription();
	void setItemQuantity(int); int getItemQuantity();
	void setItemPrice(int); int getItemPrice();
...
int main() {
	...
	cout << "\t\t\t Checkout" <<endl;
	cout << "-------------------------------------------------------------" <<endl<<endl;
	Invoice Invoice1("Ip8221","Iphone 8",3,10100000);
	Invoice Invoice2("Ip9331","Iphone 9",4,14000000);
	...
	cout << "PRICE TOTAL INVOICE Ke 1 ialah Rp. "<<Invoice1.getInvoiceAmount()<<",-" <<endl<<endl;
	...
	cout << "PRICE TOTAL INVOICE Ke 2 ialah Rp. "<< Invoice2.getInvoiceAmount()<<",-" <<endl<<endl;
}
